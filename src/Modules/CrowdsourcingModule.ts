...
export default class CrowdsourcingModule {
	...
	public deletePlaceAddress = Crowdsourcing.deletePlaceAddress;
	public deletePlaceAdmission = Crowdsourcing.deletePlaceAdmission;
	public deletePlaceAttribute = Crowdsourcing.deletePlaceAttribute;
	public deletePlaceEmail = Crowdsourcing.deletePlaceEmail;
	public deletePlaceName = Crowdsourcing.deletePlaceName;
	public deletePlaceOpeningHours = Crowdsourcing.deletePlaceOpeningHours;
	public deletePlaceOpeningHoursNote = Crowdsourcing.deletePlaceOpeningHoursNote;
	public deletePlacePhone = Crowdsourcing.deletePlacePhone;
	public deletePlaceReference = Crowdsourcing.deletePlaceReference;
