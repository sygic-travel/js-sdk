	...
	alerts: [
		{
			...
			valid_from: "2018-04-24T04:00:00+00:00",
			valid_to: "2018-04-25T04:00:00+00:00",
			updated_at: "2018-04-24T07:39:10+00:00",
			origin: "cap_collator_bot",
			provider: "vigilance@meteo.fr",
			provider_url: "vigilance@meteo.fr"
		}
	]
};
...
export const detailedAlert = {
	alert: {
		...
		web_url: "http://vigilance.meteofrance.com/",
		external_id: "2.49.0.0.250.0.FR.20180424060233.168028",
		geometry: null
	}
};
/* tslint:enable */
